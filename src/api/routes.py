...
from src.library import get_library_item, list_challenges, list_library
from src.puzzles import get_puzzle, list_puzzles, solution_lines_of
from src.rules import START_FEN, Move, legal_targets, parse_fen
...
def capabilities():
    return {
        ...
        "planned": ["pikafish", "llm_debate", "opening_book", "accounts", "repetition_rules"],
    }
